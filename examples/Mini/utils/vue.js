...
var vuePlugin = {
    ...
    monitor: function (notify) {
        ...
        if (Vue && Vue.config) {
            var originErrorHandle_1 = Vue.config.errorHandler;
            Vue.config.errorHandler = function (err, vm, info) {
                ...
                return originErrorHandle_1 === null || originErrorHandle_1 === void 0 ? void 0 : originErrorHandle_1(err, vm, info);
            };
        }
    },
    transform: function (_a) {
        var collectedData = _a.data, vm = _a.vm;
        var Vue = this.options.vue;
        if (variableTypeDetection.isString(Vue === null || Vue === void 0 ? void 0 : Vue.version)) {
            switch (getBigVersion(Vue === null || Vue === void 0 ? void 0 : Vue.version)) {
                case 2:
                    return __assign(__assign({}, collectedData), vue2VmHandler(vm));
                case 3:
                    return __assign(__assign({}, collectedData), vue3VmHandler(vm));
                default:
                    return collectedData;
            }
        }
    ...
    consumer: function (data) {
        var breadcrumbStack = this.breadcrumb.push({
            type: "Vue",
            category: getBreadcrumbCategoryInBrowser("Vue"),
            data: data,
            level: Severity.Error
        });
